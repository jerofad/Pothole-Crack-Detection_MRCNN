"""
Mask R-CNN
Train on the pot_crack robot dataset.
...
Usage: import the module (see Jupyter notebooks for examples), or run from
    ...
    python pot_crack.py train --dataset=/home/.../mask_rcnn/data/pot_crack/ --weights=coco

    #Train a new model starting from pre-trained ImageNet weights
    python pot_crack.py train --dataset=/home/.../mask_rcnn/data/pot_crack/ --weights=imagenet

    # Continue training the last model you trained. This will find
    # the last trained weights in the model directory.
    python pot_crack.py train --dataset=/home/.../mask_rcnn/data/pot_crack/ --weights=last
    ...
    python pot_crack.py splash --weights=last --image=/home/...../*.jpg

    #Detect and color splash on a video with a specific pre-trained weights of yours.
    python sugery.py splash --weights=/home/.../logs/mask_rcnn_pot_crack_0030.h5  --video=/home/simon/Videos/Center.wmv
"""
...
class Pot_crackDataset(utils.Dataset):
    def load_VIA(self, dataset_dir, subset, hc=False):
        """Load the pot_crack dataset from VIA.
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        """
        # If not a pot_crack dataset image, delegate to parent class.
        image_info = self.image_info[image_id]
        if image_info["source"] != "pot_crack":
...
def train(model, *dic):
    """Train the model."""
    # Training dataset.
    dataset_train = Pot_crackDataset()
    dataset_train.load_VIA(args.dataset, "train")
    dataset_train.prepare()

    # Validation dataset
    dataset_val = Pot_crackDataset()
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Train Mask R-CNN to detect Pothole and Road Cracks.')
    parser.add_argument("command",
                        metavar="<command>",
                        help="'train' or 'splash'")
    parser.add_argument('--dataset', required=False,
                        metavar="/home/simon/mask_rcnn/data/pot_crack",
                        help='Directory of the pot_crack dataset')
    ...
    # Configurations
    if args.command == "train":
        config = Pot_crackConfig()
    else:
        class InferenceConfig(Pot_crackConfig):
